...
import  os
from shared.utilities import scd1
...
filename = "local_test_data/bofa_credit/eStmt_2017-07-15.pdf"
...
master_df = spark.read.csv("local_test_data/bofa_cc_master/2017-07-15/part-00000-e1930cff-1cb9-425f-9d50-07b525f5cd67-c000.csv",header=True,schema=trans_schema)

master_df.show()

FINAL_DF = scd1(union_df,master_df)
FINAL_DF.coalesce(1).write.format("csv").mode("overwrite").save(
    "local_test_data/bofa_cc_master/2017-07-15/part-00000-e1930cff-1cb9-425f-9d50-07b525f5cd67-c000.csv",header="true")
exit()
